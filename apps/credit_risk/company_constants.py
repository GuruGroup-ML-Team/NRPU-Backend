...
# Mapping of ratio categories to their labels in the CSV data
...
# Reverse mapping for lookup - helps with matching from actual data paths to our constants
REVERSE_COMPANY_FINANCIAL_FIELDS = {v: k for k, v in COMPANY_FINANCIAL_FIELDS.items()}

# Company Ratio Scoring Thresholds
...
# Rating interpretations for detailed output
