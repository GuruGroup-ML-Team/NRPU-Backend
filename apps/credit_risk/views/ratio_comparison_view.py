...
class RatioComparisonView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            print("📥 entity_type:", request.query_params.get("entity_type"))
            print("📥 sector:", request.query_params.get("sector"))
            print("📥 sub_sector:", request.query_params.get("sub_sector"))
            print("📥 org_name:", request.query_params.get("org_name"))
            print("📥 year:", request.query_params.get("year"))
